# Benchmark
 The primary scope of this dataset is to support the development of movie recommender systems, and this is the first large-scale dataset in the recommender systems community that provides all types of precomputed content-based descriptors in conjunction with metadata in numerical feature format. Part of these data is used in the  <a href="https://dl.acm.org/citation.cfm?id=1864733" target="_blank">MediaEval 2018 </a> (the task: "Recommending Movies Using Content: Which content is key?")
